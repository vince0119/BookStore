...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/updateDeleteAction.css" />
    </head>
    <body>
        <c:set var="user" value="${sessionScope.USER_DTO}" />
        <c:set var="book" value="${sessionScope.BOOK_SELECTED}" />
        <c:set var="categorySelected" value="${sessionScope.CATEGOTY_SELECTED}" />
        <div class="header">
            <p>Dash Board</p>
        </div>
        <div class="main" >
            <div class="container" >
                ...
                <form class="content" action="DispatchServlet" method="POST">
                    <div class="content-text" >Update Or Delete</div>
                    <div class="content-form" >
                        <div class="content-form-left">
                            ...
                            <div class="block-content">
                                <p>Image</p>
                                <input type="text" name="txtImage" value="${book.image}" />
                            </div>
                            <div class="block-content">
                                <p>Description</p>
                                <input type="text" name="txtDescription" value="${book.description}" />
                            </div>
                            <div class="block-content">
                                <p>Price</p>
                        ...
                        <div class="content-form-right" >
                            <div class="block-content">
                                <p>Author</p>
                                <input type="text" name="txtAuthor" value="${book.author}" />
                            </div>
                            <div class="block-content">
                                <p>Quantity</p>
                                <input type="text" name="txtQuantity" value="${book.quantity}" />
                            </div>
                            <div class="block-content">
                                <p>Category Name</p>
                                <div class="block-content-category">
                                    <select name="txtCategoryName">
                                        ...
                                        <c:forEach var="category" items="${categories}">
                                            <c:if test="${categorySelected eq category.categoryName}">
                                                <option selected="selected">${category.categoryName}</option>
                                            </c:if>
                                            <c:if test="${not(categorySelected eq category.categoryName)}" >
                    ...
                    <div class="btn-group">
                        ...
                        <input class="btn-update-book" type="submit" value="Update" name="btnAction" />
                        <input class="btn-delete-book" type="submit" value="Delete" name="btnAction" />
                    </div>
                    <%-- Error Message --%>
