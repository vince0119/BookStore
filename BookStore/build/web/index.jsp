        ...
        <div class="header" >
            ...
            <c:if test="${isLoginned eq false}" >
                ...
                <div class="shopping-cart">
                    <a class="cart-link" href="login.jsp">Cart</a>
                </div>
            </c:if>
            ...
            <div class="container" >
                ...
                <div class="hotdeal">
                    <div class="hotdeal-text">
                        <p>Hot Search</p>
                        <c:set var="isLogin" value="${sessionScope.IS_LOGINNED}"/>
                    </div>
                    <div class="products-hotlist">
                        <c:set var="hotBookList" 
                               value="${sessionScope.HOT_BOOK_LIST}"/>
                        <c:if test="${not empty hotBookList}" >
                            <c:forEach items="${hotBookList}" 
                                       var="book" 
                                       varStatus="counter" >
                ...
                <div class="extra-code"></div>
                <div class="products-suggesion" >
                    <div class="suggestion-text">
                        <p>Today Suggestion </p>
                    </div>
                    <div class="products-random">
                        <c:set var="randomBookList" 
                               value="${sessionScope.RANDOM_BOOK_LIST}"/>
                        <c:if test="${not empty randomBookList}" >
                            <c:forEach items="${randomBookList}" 
                                       var="book" 
                                       varStatus="counter" >
                                <form class="product-card"  action="DispatchServlet" method="POST">
                                    <img src="${book.image}"/>
                                    <h2>
                                        ${book.title}
                                        <input type="hidden" name="txtTitle" 
